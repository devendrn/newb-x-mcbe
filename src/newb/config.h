...
#define NL_TINT vec3(1.0,1.0,1.0) // [toggle] color overlay
...
//#define NL_OVERWORLD_AMBIENT vec3(0.392,0.788,1.0)
...
//#define NL_LANTERN_WAVE 0.1   // [toggle] 0.05 subtle ~ 0.4 large swing
...
#define NL_CLOUD0_THICKNESS 8.0      // 0.5 slim ~ 8.0 fat
...
//#define NL_AURORA_VELOCITY 0.0 // 0.0 static ~ 0.3 very fast
