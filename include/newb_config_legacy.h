...
#define NL_MORNING_SUN_COL vec3(1, 0.47, 0.06)
#define NL_NOON_SUN_COL    vec3(1.0,0.75,0.57)
#define NL_NIGHT_SUN_COL   vec3(0.5,0.64,1.00)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1, 0.47, 0.06)
#define NL_UNDERWATER_TORCH_COL vec3(1, 0.47, 0.06)
#define NL_NETHER_TORCH_COL     vec3(1, 0.47, 0.06)
#define NL_END_TORCH_COL        vec3(1, 0.47, 0.06)

/* Fog */
#define NL_FOG_TYPE 2        // 0:no fog, 1:vanilla, 2:smoother vanilla
#define NL_MIST_DENSITY 0.20 // 0.0 no mist ~ 1.0 misty

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.15,0.45,1.0)
#define NL_DAY_HORIZON_COL   vec3(0.65, 0.69, 0.72)
#define NL_NIGHT_ZENITH_COL  vec3(0.02, 0.1, 0.24)
#define NL_NIGHT_HORIZON_COL vec3(0.07, 0.24, 0.52)
#define NL_RAIN_ZENITH_COL   vec3(0.37, 0.4, 0.42)
#define NL_RAIN_HORIZON_COL  vec3(0.52, 0.57, 0.6)
#define NL_END_ZENITH_COL    vec3(0.27,0.06,0.45)
#define NL_END_HORIZON_COL   vec3(0.73,0.48,0.94)
#define NL_DAWN_HORIZON_COL  vec3(1, 0.13, 0)
#define NL_DAWN_EDGE_COL     vec3(1, 0.13, 0)
...
#define NL_UNDERWATER_TINT vec3(0.05, 0.47, 0.76)
...
/* Rain effects */
#define NL_RAIN_MIST_OPACITY 0.04 // [toggle] 0.04 very subtle ~ 0.5 thick mist blow
