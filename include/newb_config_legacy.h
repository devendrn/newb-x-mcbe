...
#define NL_TINT vec3(0.98,0.99,0.99) // [toggle] color overlay
...
#define NL_END_TORCH_COL        vec3(0.78,0.47,0.88)
...
#define NL_DAY_ZENITH_COL    vec3(0.0,0.18,0.78)
#define NL_DAY_HORIZON_COL   vec3(0.8,0.97,1.0)
#define NL_NIGHT_ZENITH_COL  vec3(0.0,0.0,0.0)
#define NL_NIGHT_HORIZON_COL vec3(0.03,0.16,0.29)
...
#define NL_DAWN_HORIZON_COL  vec3(1.0,0.54,0.14)
#define NL_DAWN_EDGE_COL     vec3(1.0,0.91,0.6)
...
#define NL_WATER_TINT vec3(0.01,0.30,0.75)
...
#define NL_UNDERWATER_TINT vec3(0.01,0.29,0.75)
...
#define NL_CLOUD2_SHAPE 0.60         // 0.0 round ~ 1.0 box
#define NL_CLOUD2_DENSITY 3.0        // 1.0 blurry ~ 100.0 sharp
#define NL_CLOUD2_VELOCIY 1.0        // 0.0 static ~ 4.0 very fast
...
/* Rain effects */
#define NL_RAIN_MIST_OPACITY 0.25 // [toggle] 0.04 very subtle ~ 0.5 thick mist blow
...
/* Sun/Moon */
#define NL_SUNMOON_ANGLE -16.0 // [toggle] 0.0 no tilt - 90.0 tilt of 90 degrees
